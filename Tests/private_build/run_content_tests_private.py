...
from Tests.scripts.utils.log_util import install_simple_logging, ParallelLoggingManager, install_logging
...
logging: ParallelLoggingManager = None
...
def execute_testing(tests_settings: SettingsTester, server_ip: str, all_tests: set,
    ...
    disable_all_integrations(xsoar_client, logging)
